---
title: "Lui et al NPC dataset: `r params$sample_name`"
output: html_notebook
params:
  sample_name: "GSM6248647_NPC_ST6"
---

**These datasets have no mito genes.**
...
- `MS4A1` is CD20
```{r}
ggspavis::plotCoords(spe, annotate = "MS4A1",  feature_names = "Symbol") +
ggspavis::plotCoords(spe, annotate = "CD3G", feature_names = "Symbol")
```
