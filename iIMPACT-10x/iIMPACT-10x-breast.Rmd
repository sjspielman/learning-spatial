---
title: "Breast: 10x dataset with iIMPACT manual annotations"
...
```{r}
sample_dir <- file.path(data_path, "breast")
...
annots <- readr::read_csv(
  file.path(sample_dir, "10x_human_breast_cancer_ffpe_manual_annotation.csv")
) |>
...
```{r}
spe <- BayesSpace::qTune(spe, qs=seq(2, 20), platform="Visium", cores=4)
