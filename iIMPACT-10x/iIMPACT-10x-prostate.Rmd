---
title: "Prostate: 10x dataset with iIMPACT manual annotations"
...
```{r}
sample_dir <- file.path(data_path, "prostate")
...
annots <- readr::read_csv(
  file.path(sample_dir, "10x_human_prostate_cancer_ffpe_manual_annotation.csv")
) |>
  ...
  dplyr::mutate(
    annotation = dplyr::case_when(
      ...
      annotation == "blue" ~ "stroma and partially atrophic changes",
      annotation == "orange" ~ "stroma"
    )
  )
annots
```
